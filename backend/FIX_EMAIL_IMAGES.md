...
async def upload_image(file: UploadFile = File(...), current_user: dict = Depends(get_current_user)):
    ...
    backend_url = os.getenv('REACT_APP_BACKEND_URL', 'https://dailymanna-1.preview.emergentagent.com')
...
# Test en production
curl -I https://dailymanna-1.preview.emergentagent.com/api/uploads/campaign_20251128_222925_94bb10e4.jpeg
```
