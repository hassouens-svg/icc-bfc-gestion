...
class TestAnalyticsEndpoints:
    ...
    def test_promotions_detailed_filter_year_2024(self):
        ...
        assert summary["total_personnes_recues"] > 0, f"Expected 2024 visitors, got {summary['total_personnes_recues']}"
        assert summary["total_personnes_recues"] == 53, f"Expected 53 visitors for 2024, got {summary['total_personnes_recues']}"
        print(f"✓ Promotions detailed (2024): {summary['total_personnes_recues']} visitors")
    ...
    def test_promotions_detailed_filter_month_and_year(self):
        ...
        assert summary["total_personnes_recues"] > 0, f"Expected August 2024 visitors, got {summary['total_personnes_recues']}"
        assert summary["total_personnes_recues"] == 8, f"Expected 8 visitors for 2024-08, got {summary['total_personnes_recues']}"
        print(f"✓ Promotions detailed (2024-08): {summary['total_personnes_recues']} visitors")
