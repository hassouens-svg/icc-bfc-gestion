...
Backend URL: https://impact-dashboard-4.preview.emergentagent.com/api
"""
...
BASE_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://impact-dashboard-4.preview.emergentagent.com')
