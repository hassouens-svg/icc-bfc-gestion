...
Backend URL: https://church-campaign-hub.preview.emergentagent.com/api
"""
...
BASE_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://church-campaign-hub.preview.emergentagent.com')
