...
Backend URL: https://church-shepherd-app.preview.emergentagent.com/api
"""
...
BASE_URL = os.getenv('REACT_APP_BACKEND_URL', 'https://church-shepherd-app.preview.emergentagent.com')
