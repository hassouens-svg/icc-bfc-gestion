      ...
      <div className="space-y-6">
        ...
        {selectedView === 'promotions' && promosData && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
              ...
              {/* 6. Visiteurs Supprimés */}
              <Card 
                className="cursor-pointer hover:shadow-lg transition-shadow"
                onClick={() => navigate('/deleted-visitors')}
              >
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-center py-3 px-4">Pers. Reçues (NA)</th>
        ...
        {selectedView === 'fi' && fiData && (
          <>
            ...
            {/* DÉPLACÉ ICI: Fidélisation par FI (sous Analyse Présences) */}
            <Card>
              <CardHeader>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-pink-100">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-3 bg-purple-50 rounded">
                        ...
                        <p className="text-3xl font-bold text-purple-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.gagneurs_ame || 0}</p>
                      </div>
                      <div className="text-center p-3 bg-pink-50 rounded">
                        <p className="text-xs text-gray-600">Pers. réceptives</p>
                        <p className="text-3xl font-bold text-pink-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.personnes_receptives || 0}</p>
                      </div>
                      <div className="text-center p-3 bg-green-50 rounded">
                        <p className="text-xs text-gray-600">Prières salut</p>
                        <p className="text-3xl font-bold text-green-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.priere_salut || 0}</p>
                      </div>
                      <div className="text-center p-3 bg-blue-50 rounded">
                        <p className="text-xs text-gray-600">Contacts pris</p>
                        <p className="text-3xl font-bold text-blue-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.contacts_pris || 0}</p>
                      </div>
                      <div className="text-center p-3 bg-indigo-50 rounded">
                        <p className="text-xs text-gray-600">Âmes invitées</p>
                        <p className="text-3xl font-bold text-indigo-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.ames_invitees || 0}</p>
                      </div>
                      <div className="text-center p-3 bg-yellow-50 rounded">
                        <p className="text-xs text-gray-600">Miracles</p>
                        <p className="text-3xl font-bold text-yellow-600">{evangelisationStats?.stats_by_city?.[0]?.evangelisation?.familles_impact?.miracles || 0}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-4">Évangélisation Église</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-3 bg-purple-50 rounded">
                        <p className="text-xs text-gray-600">Gagneurs d'âme</p>
