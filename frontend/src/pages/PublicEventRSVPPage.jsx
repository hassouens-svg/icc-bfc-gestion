    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/api/events/${eventId}/rsvp-public`, {
        ...
        body: JSON.stringify({
          ...
          city: event.require_city ? formData.city : null,
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex gap-3">
                    <Button
                      onClick={() => {
                        setShowForm(false);
                        setFormData({first_name: '', last_name: '', city: '', is_star: false, payment_method: '', email: '', phone: ''});
                      }}
                      variant="outline"
                      className="flex-1"
                      disabled={submitting}
                  ...
                  {/* Lien personnalisé masqué - sera affiché uniquement après confirmation si paiement par carte */}
                </div>
              )}
