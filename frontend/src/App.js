...
import RecensementStarsMerciPage from './pages/RecensementStarsMerciPage';
import RemonteeStarsPage from './pages/RemonteeStarsPage';
import AdminRemonteesPage from './pages/AdminRemonteesPage';
