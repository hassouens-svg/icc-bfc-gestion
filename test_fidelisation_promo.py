...
def test_api_fidelisation():
    ...
    login_response = requests.post(
        "https://faith-hub-23.preview.emergentagent.com/api/auth/login",
    ...
    promo_response = requests.get(
        "https://faith-hub-23.preview.emergentagent.com/api/analytics/promotions-detailed?ville=Dijon&mois=11&annee=2024",
        headers=headers
    )
    ...
    fid_response = requests.get(
        "https://faith-hub-23.preview.emergentagent.com/api/fidelisation/referent",
        headers=headers
    )
...
def main():
    ...
    if success:
        ...
        print(f"  URL: https://faith-hub-23.preview.emergentagent.com/login")
